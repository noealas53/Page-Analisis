...
return (
    ...
    <div className="bg-blue-500 w-96 h-auto rounded-lg pt-8 pb-8 px-8 flex flex-col items-center">
            <label className="font-light text-4xl mb-4"><span className="font-bold">Login</span></label>
                    ...
                    <input className="w-full h-12 rounded-lg px-4 text-lg focus:ring-blue-600 mb-4"
                        ...
                        value={password}
                    />
                    <button className="mt-6 w-full transition rounded border border-blue-500 duration-300 ease-in-out text-xl text-extrabold uppercase bg-gray-500 hover:bg-gray-800 py-2 px-4 text-gray-100">Sign In </button>
                </form>
